        ...
        setContent {
            LumiTheme {
                Scaffold(
                    ...
                    topBar = { LumiTopAppBar() },
                    bottomBar = { LumiNavigationBar() },
                    floatingActionButton = {  }
                ) { innerPadding ->
                    LumiHomeScreen(modifier = Modifier.padding(innerPadding))
                }
            }
        }
    }
...
@Composable
fun LumiTopAppBar(modifier: Modifier = Modifier) {
...
@Composable
fun LumiNavigationBar(modifier: Modifier = Modifier) {
